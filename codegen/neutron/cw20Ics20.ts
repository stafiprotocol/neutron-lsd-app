...
export interface Cw20Ics20Schema {
  responses:
    ...
    | PortResponse;
  query: ChannelArgs | AllowedArgs | ListAllowedArgs;
  execute: ReceiveArgs | TransferArgs | AllowArgs | UpdateAdminArgs;
  [k: string]: unknown;
}
/**
...
export interface ListAllowedArgs {
  limit?: number | null;
